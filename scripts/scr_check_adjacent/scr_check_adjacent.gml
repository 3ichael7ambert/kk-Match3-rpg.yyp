/// @description  Finds the total number of matching, adjacent pieces
function scr_check_adjacent(argument0, argument1, argument2, argument3) {
	/*
	...
	*/
	...
	// If a null piece is returned, the function returns 0.
	...
	// If the other piece is defined and matches the current pieces image_Random Organization – Creating a Puzzle Game
