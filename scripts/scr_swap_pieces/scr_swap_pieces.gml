function scr_swap_pieces(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	*/
	...
	// Sets the new piece's x and y goals to the original piece'x and y goals.
	...
	scr_swap_pieces(argument0, argument1, argument2,
	argument3, true,0);
	}
	else
	{
